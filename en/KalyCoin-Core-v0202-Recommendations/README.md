...
The intended audience for these recommendations is users of Kalycoin Core, the kalycoind and Kalycoin-Qt full node wallets, who are using the Kalycoin node for staking or staking services (super staker), or other high-performance applications such as hot wallets or nodes supporting light wallets.

#### Kalycoin Core version 0.20.2

Kalycoin Core version 0.20.2 “FastLane” was released on March 20, 2012, and is available for download at https://github.com/kalycoinproject/kalycoin/releases. Version 0.20.2 is a **MANDITORY UPDATE** with a hard fork to implement new features, primarily 32-second block spacing:

* Testnet block 806,600 on March 26, 2021

* Mainnet block 845,000 approximately April 30, 2021

Any Kalycoin Core wallets that do not update before the hard fork will be disconnected from the Kalycoin network and unable to make transactions or staking with Kalycoin mainnet. There is no new coin created by the hard fork and this update only applies to the Kalycoin Core wallets kalycoind and Kalycoin-Qt.
...
```
./kalycoind -superstaking -stakingminfee=10 -stakingminutxovalue=100
```
...
![](https://kalycoin.s3.amazonaws.com/UTXOrequirements.jpg)
...
Returns the options that Kalycoin Core was started with, for example, a kalycoind super staker:
