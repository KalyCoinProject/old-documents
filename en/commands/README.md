...
The kalycoin-qt wallet will show lock status with the padlock icon and the Console returns "null". kalycoin-cli returns no status but you can check the unlock status with `getwalletinfo` for "unlocked_until": <Unix timestamp>
