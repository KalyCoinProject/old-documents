    ...
    {                           
      "transactionid" : {       
        ...
        "fees" : {
            ...
            "modified" : n,     (numeric) transaction fee with fee deltas used for mining priority in KLC
            "ancestor" : n,     (numeric) modified fees (see above) of in-mempool ancestors (including this one) in KLC
            "descendant" : n,   (numeric) modified fees (see above) of in-mempool descendants (including this one) in KLC
        }
...
**Result:**

     {
      "unspents": [
       ...
       ,...], 
     "total_amount" : x.xxx,          (numeric) The total amount of all found unspent outputs in KLC
    ] 
...
The difference between echo and echojson is that echojson has argument conversion enabled in the client-side table inkalycoin-cli and the GUI. There is no server-side difference.
...
**Result:**

    {
      ...
      "incrementalfee": x.xxxxxxxx,          (numeric) minimum fee increment for mempool limiting or BIP 125 replacement in KLC/kB
...
Combine multiple partially signed Kalycoin transactions into one transaction.
...
**Examples:**
    ...
    > kalycoin-cli combinepsbt ["mybase64_1", "mybase64_2", "mybase64_3"]
    ...
    2. options                    (object, optional)
       {
         ...
         "subtractFeeFromOutputs" (array, optional) A json array of integers.
                                  ...
                                  Those recipients will receive less kalycoins than you enter in their corresponding amount field.
...
Each key is a Kalycoin address or hex-encoded public key.
...
**Arguments:**
    ...
    1. "filename"    (string, required) The filename with path (either absolute or relative to kalycoind)
...
**Result:**

    {
      ...
      "account" : "account"         (string) DEPRECATED. This field will be removed in V0.18. To see this deprecated field, start kalycoind with -deprecatedrpc=accounts. The account associated with the address, "" is the default account
...
Returns a new Kalycoin address for receiving payments.
...
Returns a new Kalycoin address, for receiving change.
...
**Result:**

    {
      ...
      "details" : [
        {
          "account" : "accountname",        (string) DEPRECATED. This field will be removed in a V0.18. To see this deprecated field, start kalycoind with -deprecatedrpc=accounts. The account name involved in the transaction, can be "" for the default account.
...
**Result:**

    {
      ...
      "unconfirmed_balance": xxx,        (numeric) the total unconfirmed balance of the wallet in KLC
      "immature_balance": xxxxxx,        (numeric) the total immature balance of the wallet in KLC
...
**Arguments:**
    ...
    1. "kalycoinprivkey" (string, required) The private key (see dumpprivkey)
    2. "label"       (string, optional, default="") An optional label
    3. rescan        (boolean, optional, default=true) Rescan the wallet for transactions
...
**Result:**

    {
      "transactions": 
      [
        "account":"accountname",       (string) DEPRECATED. This field will be removed in V0.18. To see this deprecated field, start kalycoind with -deprecatedrpc=accounts. The account name associated with the transaction. Will be "" for the default account.
...
kalycoind with -deprecatedrpc=accounts
    ...
    [                
      {
        ...
        "account" : "account",    (string) DEPRECATED. This field will be removed in V0.18. To see this deprecated field, start kalycoind with -deprecatedrpc=accounts. The associated account, or "" for the default account
...
Note that all wallet command-line options used when starting kalycoind will be
...
**Arguments:**
    ...
    5. subtractfeefromamount  (boolean, optional, default=false) The fee will be deducted from the amount being sent.
                                 The recipient will receive less kalycoins than you enter in the amount field.
    6. replaceable            (boolean, optional) Allow this transaction to be replaced by a transaction with higher fees via BIP 125
    7. conf_target            (numeric, optional) Confirmation target (in blocks)
    8. "estimate_mode"        (string, optional, default=UNSET) The fee estimate mode, must be one of:
           "UNSET"
...
**Arguments:**
    ...
    5. gasPrice          (numeric or string, optional) gasPrice Kalycoin price per gas unit, default: 0.0000004, min:0.0000004
...
**Examples:**
    ...
    > kalycoin-cli unloadwallet wallet_name
