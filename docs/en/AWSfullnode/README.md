# Using an AWS Kalycoin instance to participate in the fullnodes contest
...
**Port 3888 is already open on the AWS Kalycoin instance.**
...
`qmix` is the install and launch folder of the Qmix web IDE, it's a great open-source web IDE for Kalycoin. 
...
Qmix launches upon boot on the AWS Kalycoin AMI. To use it, just point your browser towards http://yourec2ipaddress:5555
