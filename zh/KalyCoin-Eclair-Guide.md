# Kalycoin 闪电网络客户端 Kalycoin Eclair 使用教程
...
* `sudo docker run -tid --rm -v "/opt/kalycoin:/root/.kalycoin" --name kalycoin kalycoin/kalycoin:latest kalycoind --testnet`
